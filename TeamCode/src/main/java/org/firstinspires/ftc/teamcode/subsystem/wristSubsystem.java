...
public class wristSubsystem {
    ...
    public static double rwPickup = .12; //pos while link out
    public static double rwPickup2 = .2; //pos to grab from bucket
  //  public static double lwPickup = .38;
    public static double rwIn = .22;
  //  public static double lwIn = .37;
    public static double rwPickupSpeicmen = .32;
